...
export function AdminCampaignDetailPage({ campaign }: AdminCampaignDetailPageProps) {
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Link href={`/admin/clients/${campaign.userId}`}>
                  <p className="font-semibold hover:text-primary">
                    {campaign.user?.name || campaign.user?.email || 'N/A'}
                  </p>
                </Link>
              </div>
              <div>
